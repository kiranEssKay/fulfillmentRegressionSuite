...
import getShopperById.ShopperByIdTestData;
...
/**
 * Created by AurigaIT on 4/5/2016.
 */
public class GetShopperByMerchantId {
    ...
    public void GetShopperByMerchantIdTest() throws IOException {
        ...
        ShopperByMerchantIdTestData apiTestData = (ShopperByMerchantIdTestData) FixtureUtils.getAsObject(ShopperByMerchantIdTestData.class, "src/main/java/resources/getShopperByMerchantId.json");
