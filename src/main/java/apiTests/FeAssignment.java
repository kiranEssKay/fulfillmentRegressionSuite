...
public class FeAssignment {
    ...
    public void FeAssignmentTest() throws IOException {
        ...
        FeAssignmentApiTestData apiTestData = (FeAssignmentApiTestData) FixtureUtils.getAsObject(FeAssignmentApiTestData.class, "src/main/java/resources/feAssignment.json");

        Call<FeAssignmentResponse> call = service.postOrder("Saurabh"+InsertOrder.orderNo, apiTestData.getRequest());
